...
\end{figure}
    ...
    \begin{enumerate}[label=(\alph*)]
        ...
        \textcolor{red}{Adaptation has made the model accurate.}
        ...
        \textcolor{red}{The model has achieved the perfect accuracy but did not overfit to data.}
...
\end{figure}
        ...
        \textcolor{red}{Lowering the inner learning rate had negative effect on optimization and generalization.}
